...
try {
    ...
    $container = (new \Joomla\DI\Container)
        ->registerServiceProvider(new EtdSolutions\Service\ConfigurationProvider(JPATH_ROOT . '/etc/config_front.json'))
...
(new EtdSolutions\EtdBniFeedback\Application\Front(null, $container->get('config')))
